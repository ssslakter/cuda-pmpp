...
# kernel path: /tmp/torchinductor_slakter/xx/cxxb6tj3m2w7s4eqi3qpcmvk4yjm2zvslalchu4m2mzrc5uq5hvn.py
# Source Nodes: [softmax], Original ATen: [aten._softmax]
# softmax => amax, div, exp, sub, sum_1
triton_per_fused__softmax_0 = async_compile.triton('triton_', '''
import triton
...
@persistent_reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_0', 'mutated_arg_names': []}
)
@triton.jit
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf2 = empty((10, ), device='cuda', dtype=torch.float32)
        # Source Nodes: [softmax], Original ATen: [aten._softmax]
        stream0 = get_cuda_stream(0)
        triton_per_fused__softmax_0.run(arg0_1, buf2, 1, 10, grid=grid(1), stream=stream0)
        del arg0_1
        return (buf2, )
